...
#include "stanExports_emax_binary.h"

RCPP_MODULE(stan_fit4emax_binary_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_emax_binary")
